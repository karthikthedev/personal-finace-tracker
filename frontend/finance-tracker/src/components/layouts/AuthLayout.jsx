...
import { LuTrendingUpDown } from "react-icons/lu"; // Assuming this is the right icon
  ...
  return (
    <div className="flex">
      ...
      <div className="hidden md:block w-[40vw] h-screen bg-violet-50 bg-auto-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative">
        ...
        <div className="w-48 h-56 rounded-[40px] border-[20px] border-fuchsia-600 absolute top-[30%] right-8"></div>
